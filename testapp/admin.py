...
class CustomUserAdmin(UserAdmin):
    ...
    fieldsets = (
        ...
        ('Verification Info', {'fields': ('qr_code', 'qr_code_data', 'qr_delivered', 'qr_verified', 'fingerprint_data','fingerprint_verified')}),
    ...
    add_fieldsets = (
        (None, {
            'classes': ('wide',),
            'fields': ('email', 'username', 'password1', 'password2', 'role', 'phone_number', 'is_active', 'qr_delivered', 'qr_verified','fingerprint_verified'),
        }),
    )
